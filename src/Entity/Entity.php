...
class Entity
{
	 ...
	 */
	public function getAll($fields = '*',$limit='30')
	{
            
		$sql = "SELECT " . $fields .  " FROM " . $this->table . "LIMIT =". $limit;
	 ...
	 * 
	 */
	public function where($where, $fields = '*', $more = 'AND',$limit='30')
	{
		foreach($where as $key => $w) {
			$whereSql = $key . ' = :' . $key;
		}

		$sql = "SELECT " . $fields .  " FROM " . $this->table . " WHERE " . $whereSql . "LIMIT =". $limit;
